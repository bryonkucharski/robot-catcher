...
class rl_agent:
    ...
    def update(self, s, a, r, s_):
        ...
        ##### UPDATE THIS #####
        exp =  # determine the expected value of the next step
        current =  # determmine the current value of the current step
        ##########
        ...
        '''
        ##### UPDATE THIS #####
        self.q_table[s][a] =   # update the spot in the q table    
        ##########
    ...
    def get_action(self, state):
        ...
        if np.random.rand() < self.epsilon:
            action = #argmax of the row given the current state
        else:
