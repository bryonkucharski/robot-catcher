...
while True:
    ...
    if elapsed > 1/UPDATE_FREQ: #how fast the ball should move
        ...
        print('ACTON: ' + str(action))
        print('Is this a valid Move: ' + str(check_valid_move(ball_x, ball_y, action)))
        ...
        print('itr: ' + str(itr) + ' steps: ' + str(steps) + ' state: ' + str(state) +' reward: ' + str(reward))
